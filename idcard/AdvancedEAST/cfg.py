...
max_train_img_size = int(train_task)
max_predict_img_size = int(train_task)
...
data_dir = "D:/idcard/dataset/card/"
origin_image_dir_name = "image/"
origin_txt_dir_name = "txt/"
train_image_dir_name = "images_for_train/"
train_label_dir_name = "labels_for_train/"
...
model_weights_path = 'model/weights.{epoch:03d}-{val_loss:.3f}.h5'
saved_model_file_path = 'saved_model/east_model.h5'
saved_model_weights_file_path = 'saved_model/east_model_weights.h5'
