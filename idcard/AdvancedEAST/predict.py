...
def predict(img_path, model_path, pixel_threshold=cfg.pixel_threshold, quiet=False):
...
if __name__ == '__main__':
    ...
    east = East()
    east_detect = east.east_network()
    model_path=cfg.saved_model_weights_file_path
    predict(img_path, model_path, threshold)
